...
@Getter
@Setter
public class LostItemUpdateForm {
    ...
    public static LostItemUpdateForm from(LostItem item, String normalizedContactInfo) {
        LostItemUpdateForm form = new LostItemUpdateForm();
        form.setCategory(item.getCategory());
        form.setItemType(item.getItemType());
        form.setTitle(item.getTitle());
        form.setDescription(item.getDescription());
        form.setLocationName(item.getLocationName());
        form.setContactInfo(normalizedContactInfo);
        form.setLatitude(item.getLatitude());
        form.setLongitude(item.getLongitude());
        return form;
    }
}
